...
const WEB_LIVE_LOADING_STEPS: WebLiveLoadingStepKey[] = [
  'loading',
  'fetching',
  'ready',
];
...
/* 播放器蒙层只有两步：加载，然后播放 */
const WEB_LIVE_PLAYER_STEPS: LoadingStep[] = [
